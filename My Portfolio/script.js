...
darkModeBtn.addEventListener('click', () => {
    ...
    btn.toggle('active');
    if (btn[1] == 'active') {
      interestedThings.classList.add('dark');
      ...
      interestedThings.classList.remove('dark')
      cssRoot.style.setProperty('--dark', '#353b48');
...
const backBtn = document.querySelector('[data-resume-back]');
...
cardsObserver.observe(wholeGrid)
